...
evaluateSubject <- function( X, evalSubject, detectorTrain, detectorScore, numTrainingExamples ) {
  ...
  maxSessionIndex = 1;
  if( numTrainingExamples > 50 ) {
    maxSessionIndex <- maxSessionIndex + 1;
    
    if( numTrainingExamples > 100 ) {
      maxSessionIndex <- maxSessionIndex + 1;
      if( numTrainingExamples > 150 ) {
          maxSessionIndex <- maxSessionIndex + 1;
        }
      }
  }
...
# Introduce noise into the data points
#print(head(X));
jitter.factor <- 750;
X$H.period <- jitter(X$H.period, factor=jitter.factor, amount = NULL);
X$DD.period.t <- jitter(X$DD.period.t, factor=jitter.factor, amount = NULL);
X$UD.period.t <- jitter(X$UD.period.t, factor=jitter.factor, amount = NULL);
X$H.t <- jitter(X$H.t, factor=jitter.factor, amount = NULL);
X$DD.t.i <- jitter(X$DD.t.i, factor=jitter.factor, amount = NULL);
X$UD.t.i <- jitter(X$UD.t.i, factor=jitter.factor, amount = NULL);
X$H.i <- jitter(X$H.i, factor=jitter.factor, amount = NULL);
X$DD.i.e <- jitter(X$DD.i.e, factor=jitter.factor, amount = NULL);
X$UD.i.e <- jitter(X$UD.i.e, factor=jitter.factor, amount = NULL);
X$H.e <- jitter(X$H.e, factor=jitter.factor, amount = NULL);
X$DD.e.five <- jitter(X$DD.e.five, factor=jitter.factor, amount = NULL);
X$UD.e.five <- jitter(X$UD.e.five, factor=jitter.factor, amount = NULL);
X$H.five <- jitter(X$H.five, factor=jitter.factor, amount = NULL);
X$DD.five.Shift.r <- jitter(X$DD.five.Shift.r, factor=jitter.factor, amount = NULL);
X$UD.five.Shift.r <- jitter(X$UD.five.Shift.r, factor=jitter.factor, amount = NULL);
X$H.Shift.r <- jitter(X$H.Shift.r, factor=jitter.factor, amount = NULL);
X$DD.Shift.r.o <- jitter(X$DD.Shift.r.o, factor=jitter.factor, amount = NULL);
X$UD.Shift.r.o <- jitter(X$UD.Shift.r.o, factor=jitter.factor, amount = NULL);
X$H.o <- jitter(X$H.o, factor=jitter.factor, amount = NULL);
X$DD.o.a <- jitter(X$DD.o.a, factor=jitter.factor, amount = NULL);
X$UD.o.a <- jitter(X$UD.o.a, factor=jitter.factor, amount = NULL);
X$H.a <- jitter(X$H.a, factor=jitter.factor, amount = NULL);
X$DD.a.n <- jitter(X$DD.a.n, factor=jitter.factor, amount = NULL);
X$UD.a.n <- jitter(X$UD.a.n, factor=jitter.factor, amount = NULL);
X$H.n <- jitter(X$H.n, factor=jitter.factor, amount = NULL);
X$DD.n.l <- jitter(X$DD.n.l, factor=jitter.factor, amount = NULL);
X$UD.n.l <- jitter(X$UD.n.l, factor=jitter.factor, amount = NULL);
X$H.l <- jitter(X$H.l, factor=jitter.factor, amount = NULL);
X$DD.l.Return <- jitter(X$DD.l.Return, factor=jitter.factor, amount = NULL);
X$UD.l.Return <- jitter(X$UD.l.Return, factor=jitter.factor, amount = NULL);
